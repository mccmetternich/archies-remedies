...
export function PDPHeroSection({
  ...
  return (
    <div className="flex flex-col lg:flex-row w-full max-w-full px-4 lg:pr-0 lg:pl-[390px]">
      ...
      <div className="order-1 lg:order-2 w-full lg:flex-1 lg:min-w-0 flex flex-col lg:sticky lg:top-[var(--pdp-header-height)] lg:h-[calc(100vh-var(--pdp-header-height))] lg:max-h-[calc(100vh-var(--pdp-header-height))] lg:isolate lg:z-10">
        <PDPGallery
          images={activeImages}
