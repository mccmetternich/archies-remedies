      ...
      >
        ...
        >
          <div className="inline-flex items-center gap-3 px-6 py-3 bg-white rounded-full shadow-sm border border-[#e5e5e5]">
            ...
            <span className="text-lg font-medium tracking-tight">Archie's Remedies</span>
          </div>
        </motion.div>
        ...
        >
          ...
          <p className="text-xl text-gray-600 mb-12 max-w-md mx-auto leading-relaxed">
            We're working on something special. Leave your email to be the first to know when we launch.
          </p>
        </motion.div>
